...
import static io.taucoin.util.ByteUtil.intToBytes;
...
public class TransactionTest {
    ...
    public void test3() throws Exception {
        ...
        Transaction tx = new Transaction(intToBytes(10000)[0], intToBytes(0)[0],longToBytes(timeNows()),
                ecKey.getAddressBindAccount(), value.toByteArray(), null);
...
//        assertEquals("14a569d327dcda4b29f74f93c0e9729d2f49ad726e703f9cd90dbb0fbf6649f1", Hex.toHexString(BigIntegers.asUnsignedByteArray(txNew.getSignature().s)));
    ...
    public void testTransactionFromNew2() throws MissingPrivateKeyException {
        ...
        byte[] version = BigIntegers.asUnsignedByteArray(BigInteger.valueOf(10000));
        byte[] option = Hex.decode("0");
        byte[] timestamp = longToBytes(timeNows());
        ...
        Transaction tx = new Transaction(version[0], option[0], timestamp, recieveAddress, value, fee);
...
// "";
        ...
        byte[] version = BigIntegers.asUnsignedByteArray(BigInteger.valueOf(10000));
        byte[] option = Hex.decode("0");       // 10000000000000
        byte[] timestamp = longToBytes(timeNows());           // 1000
        byte[] recieveAddress = null;
        byte[] amount = Hex.decode("03e8"); //10000000000000000"
        ...
        Transaction tx1 = new Transaction(version[0], option[0], timestamp,
                recieveAddress, amount, init);
