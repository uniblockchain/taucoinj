...
public final class JsonRpcServer extends io.taucoin.rpc.server.JsonRpcServer{
    ...
    public JsonRpcServer(Taucoin taucoin) {
        ...
        this.dispatcher.register(new tau_transformK(this.taucoin));
        this.dispatcher.register(new tau_transformS2T(this.taucoin));
        ...
        this.dispatcher.register(new tau_sendRawTransaction(this.taucoin));
        ...
        this.dispatcher.register(new tau_sendNewBlock(this.taucoin));
